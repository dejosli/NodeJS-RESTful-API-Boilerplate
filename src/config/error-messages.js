...
module.exports = {
  ...
  CLOUDINARY_FILE_UPDATE_ERR: 'Cloudinary file updated failure',
  CLOUDINARY_FILE_DELETE_ERR: 'Cloudinary file deletion failed',
  OTP_VERIFICATION_ERR: 'Failed to verify',
};
